...
5. 협력과 공유: 전 세계의 사람들이 함께 소프트웨어를 발전시키므로 더 빠르고 향상된 프로그램이다.
...
1.정밀기술부속 : 소프트웨어를 수정하거나 문제를 해결하려면 어떻게 해야 할까요?

2. 자체 기술 지원이 불가능함 : 소프트웨어와 운영, 고객 지원팀이나 기술 지원 서비스를 요청하는 경우가 많습니다.

3.복제 문제 : 기존의 다른 소프트웨어나 하드웨어와 호환되지 않을 경우

4.책임의 분산 : 문제가 발생했을 때 소유권을 특정 회사나 개인이 주장할 수 있는 만큼, 사용자가 직접 처리해야 할 경우가 많습니다.

5.커뮤니티 의존성 : 업데이트와 유지 관리가 커뮤니티에 의존하기 때문에 프로젝트가 중단되어야 지원이 불가능할 위험이 있습니다.
...
##오픈 소스 소프트웨어(오픈 소스 소프트웨어, OSS)는 무제한 사용할 수 있고, 프로그램의 내용을 편집하거나 공개할 수 있는 소프트웨어 를 말해요. 
